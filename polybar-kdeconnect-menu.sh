...
if ! [ -z $isavail ]
then
    MENU="$(rofi -sep "|" -dmenu -i -p 'System'  -width 15 -hide-scrollbar -theme material -line-padding 4 -padding 20 -lines 4 -font "Fantasque Sans Mono 10" <<< "Battery: $battery%|Ping|Find Device|Send File")"
                case "$MENU" in
